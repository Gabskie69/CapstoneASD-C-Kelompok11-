import TicTacToe.Board1;
import TicTacToe.Seed1;
...
public class GameMain {
    ...
    public void stepGame() {
        ...
        do {
            ...
            if (row >= 0 && row < Board1.ROWS && col >= 0 && col < Board1.COLS
                    && board.cells[row][col].content == Seed1.Seed.NO_SEED) {
